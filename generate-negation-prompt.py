...
if __name__ == "__main__":
    ...
    api_key = api_key
    model = "gpt-4o-mini"  # or whichever model you wish to use

    # Run the async driver function
    final_dataset, invalid_cases, llm_responses, error_cases = asyncio.run(
        generate_llm_responses_and_validate(converted_dict, model, api_key, max_concurrent_requests=10)
    )

    # Optional: Save results to file
    with open("/Users/yiquntchen/Downloads/test-4o-full-test-negated-dataset.jsonl", "w") as f:

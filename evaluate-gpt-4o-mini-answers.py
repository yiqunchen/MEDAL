...
with open("/Users/yiquntchen/Downloads/test-temp-4o-mini-async.json", "r") as f:
...
async def main():
	...
	# Save to file
	with open("/Users/yiquntchen/Downloads/test_4o_mini_on_4o_mini_results_with_predictions.json", "w") as f:

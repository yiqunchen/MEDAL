...
INPUT_PATH = os.getenv("EVAL_INPUT_JSON", "./data/processed/test-temp-4o-one-question-async.json")
OUTPUT_PATH = os.getenv("EVAL_OUTPUT_JSON", "./data/runs/test_4o_mini_on_4o_questions_with_predictions.json")
...
async def main():
	# Run the evaluation
    results = await evaluate_questions_parallel(question_data, client, model="gpt-4o-mini", max_concurrent=15)

...
1. A binary answer: "Yes", "No", or "Not Evidence", based on whether the available evidence supports the claim.
...
"""
        ...
        return {
            qid: {
                ...
                "negation_valid": item.get("negation-valid", ""),
            }
        }
...
# /Users/yiquntchen/Downloads/test-4o-full-test-double-negated-dataset.jsonl
load_dotenv_if_present()
OPENAI_API_KEY = require_env("OPENAI_API_KEY")
INPUT_PATH = os.getenv("EVAL_INPUT_JSONL", "./data/processed/test-4o-full-test-double-negated-dataset.jsonl")
OUTPUT_PATH = os.getenv("EVAL_OUTPUT_JSON", "./data/runs/test_4o_mini_on_4o_DOUBLE_negative_prompts_benchmark.json")
...
async def main():
	# Run the evaluation
	results = await evaluate_questions_parallel(question_data, client, model="gpt-4o", max_concurrent=2)

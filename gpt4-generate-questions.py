...
async def main():
    with open("/Users/yiquntchen/Downloads/clean_pubmed_abstract_data_no_protocol.pkl", "rb") as f:
    ...
    with open('/Users/yiquntchen/Downloads/gpt4o-multi-temp-results-test.pkl', 'wb') as f:
    ...
    write_all_qa_to_csv(
        ...
        '/Users/yiquntchen/Downloads/test-temp-4o-multi-async.csv'
    )
